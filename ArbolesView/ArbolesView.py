...
class ArbolesView(QGroupBox):
    def __init__(self,p:QWidget):
        ...
        self.canvasArea.setGeometry(40,20,980,832)
        ...
        self.tabla.setGeometry(1060,20,260,480)
        ...
        panelOpciones.setGeometry(1060,515,260,330)
        ...
        self.campoPalabra.setGeometry(60,50,140,30)
        self.campoPalabra.setFont(QFont("Arial",12))
        ...
        self.opcionTipoArbol.setGeometry(60,130,140,30)
        self.opcionTipoArbol.setFont(QFont("Arial",12))
        ...
        self.opcionPasos.setGeometry(110,230,100,30)
        self.opcionPasos.setFont(QFont("Arial",12))
        ...
        botonGenerar.setGeometry(60,270,140,30)
